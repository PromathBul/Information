...
В качестве ключей и значений могут выступать не только базовые типы, но и кортежи, но не списки. Словари в отличие от списков заключаются в фигурные скобки:
```
